...
const JANUS_HISTORICAL_MATERIALIZED_SUBQUERY_NS: &str = "https://janus.rs/materialized-history/";

#[derive(Debug, Clone)]
struct NestedSubqueryPlanningResult {
    planned_subqueries: Vec<PlannedSubquery>,
    diagnostics: Vec<SubqueryPlanningDiagnostics>,
...
impl JanusQLParser {
    ...
    fn build_historical_materialized_subqueries(
        &self,
    ...
    fn lower_physical_subquery_plan(
        &self,
    ...
    fn build_historical_materialized_definition(
        &self,
    ...
    fn build_historical_materialized_graph_pattern(
        &self,
    ...
    fn analyze_subquery_window_dependencies(
        &self,
    ...
    fn classify_subquery_execution_mode(
        &self,
    ...
    fn build_logical_subquery_plan(
        &self,
        dependencies: &SubqueryWindowDependencies,
        ...
        match execution_mode {
            ...
            SubqueryExecutionMode::LiveHistoricalJoin => {
                // TODO: support continuous nested execution:
                // Live window updates
                //        ↓
                // Historical lookup
                //        ↓
    ...
    fn build_physical_subquery_plan(
        &self,
    ...
    fn format_subquery_planning_diagnostics(
        &self,
    ...
    fn rewrite_nested_subquery_where_for_materialization(
        &self,
        where_clause: &str,
        prefixes: &HashMap<String, String>,
    ) -> Result<String, Box<dyn std::error::Error>> {
    ...
    fn brace_balance(&self, input: &str) -> isize {
    ...
    fn select_baseline_anchor_variable(&self, output_variables: &[String]) -> Option<String> {
