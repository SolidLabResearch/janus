...
describe('OxigraphAdapter', () => {
  ...
  const createAdapterWithMock = (endpoint = mockEndpoint) => {
    const mockClient = {
      post: jest.fn(),
      get: jest.fn(),
    ...
    const adapter = new OxigraphAdapter(endpoint);
  ...
  describe('loadData', () => {
    it('should load Turtle data successfully', async () => {
      ...
      expect(mockClient.post).toHaveBeenCalledWith('/store', turtleData, {
    ...
    it('should load data into named graph', async () => {
      ...
      expect(mockClient.post).toHaveBeenCalledWith(
        '/store?graph=http%3A%2F%2Fexample.org%2Fgraph1',
        turtleData,
        { headers: { 'Content-Type': 'text/turtle' } }
      );
    });
    ...
    it('should handle different RDF formats', async () => {
      ...
      for (const { format, contentType } of formats) {
        ...
        expect(mockClient.post).toHaveBeenCalledWith('/store', expect.any(String), {
  ...
  describe('query', () => {
    it('should execute SELECT query successfully', async () => {
      ...
      expect(mockClient.post).toHaveBeenCalledWith('/query', query, {
        headers: {
          'Content-Type': 'application/sparql-query',
  ...
  describe('insert', () => {
    it('should insert triple successfully', async () => {
      ...
      expect(mockClient.post).toHaveBeenCalledWith('/update', expect.any(String), {
  ...
  describe('clear', () => {
    it('should clear store successfully', async () => {
      ...
      expect(mockClient.post).toHaveBeenCalledWith('/update', 'CLEAR ALL', {
        headers: { 'Content-Type': 'application/sparql-update' },
      });
    });
  });
  ...
  describe('export', () => {
    it('should export data in specified format', async () => {
      ...
      expect(mockClient.get).toHaveBeenCalledWith('/store', {
