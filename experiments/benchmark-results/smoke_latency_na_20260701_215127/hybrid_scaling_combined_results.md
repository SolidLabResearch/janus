...
|---|---:|---|---|---|---:|---:|---:|---:|---|
| point_lookup | 10000 | Janus Unified | janus_segmented | janus_range_lookup | N/A | N/A | 0.000 ± 0.000 ms | 0.000 ± 0.000 ms | 100% |
| point_lookup | 10000 | Decomposed-Oxigraph | oxigraph | sparql_filter | N/A | N/A | 5.000 ± 0.000 ms | 0.000 ± 0.000 ms | 100% |
...
| point_lookup | Decomposed-Oxigraph | 5.000 ms | N/A | N/A | N/A | flat |
...
|---|---:|---|---:|---:|---:|---:|
| point_lookup | 10000 | Janus Unified | 23.688 ± 0.000 MB | 2.828 ± 0.000 MB | 2.058 ± 0.000% | 8.660 ± 0.000% |
| point_lookup | 10000 | Decomposed-Oxigraph | 44.562 ± 0.000 MB | 20.344 ± 0.000 MB | 2.051 ± 0.000% | 8.747 ± 0.000% |
